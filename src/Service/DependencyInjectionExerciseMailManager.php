 ...
 * @see plugin_api
 */
class DependencyInjectionExerciseMailManager extends DefaultPluginManager implements MailManagerInterface {
  ...
  public function doMail($module, $key, $to, $langcode, $params = [], $reply = NULL, $send = TRUE) {
    ...
    // Overwrite the value of the variable 'to'.
    // Now all emails will be sent to the fixed address.
